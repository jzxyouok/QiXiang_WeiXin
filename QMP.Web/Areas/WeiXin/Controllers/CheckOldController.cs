...
{
    public class CheckOldController : Controller
    {
        //
        // GET: /WeiXin/Check/

        //public readonly string Token = WebConfigurationManager.AppSettings["WeiXinToken"];
        ...
        public ActionResult Post(PostModel postModel)
        {
            ...
            var messageHandler = new WeiXinMessageHandler(Request.InputStream, postModel);
